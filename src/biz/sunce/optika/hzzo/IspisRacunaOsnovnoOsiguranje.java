...
public final class IspisRacunaOsnovnoOsiguranje implements Printable {
	...
	public int print(Graphics g, PageFormat pageFormat, int pageIndex)
		...
		/*
		 * int sirinaStranice=(int)pageFormat.getImageableWidth(); int
		 * visinaStranice=(int)pageFormat.getImageableHeight(); int
		 * pocetakStraniceX=(int)pageFormat.getImageableX(); int
		 * pocetakStraniceY=(int)pageFormat.getImageableY();
		 */
