...
public class PictureResizer {
  ...
  public byte[] preformatirajSlikuKaoJPEG(java.io.InputStream ins,int potrebnaSirina, int potrebnaDuzina, float kvaliteta)
    {
      int sirina,duzina;
     byte[] out;
          ...
          int velicina=ins.available();
           ...
           if (potrebnaDuzina>0)
           {
            ...
            duzina*=omjerD;
                 ...
                 java.awt.image.BufferedImage image = new java.awt.image.BufferedImage(sirina, duzina, java.awt.image.BufferedImage.TYPE_INT_RGB);
                ...
                graf.setRenderingHint(java.awt.RenderingHints.KEY_INTERPOLATION,java.awt.RenderingHints.VALUE_INTERPOLATION_BICUBIC);
            ...
            {
              Logger.log("Null pointer greska kod smanjivanja slike: "+e+" Linija: "+e.getStackTrace()[0].getLineNumber());
              return null;
            }
            catch (java.io.IOException ioe)
            {
              Logger.log("IO greska kod smanjivanja slike: "+ioe+" Linija: "+ioe.getStackTrace()[0].getLineNumber());
              return null;
            }
   ...
   return out;
    ...
    public byte[] preformatirajSlikuKaoJPEG(java.awt.image.BufferedImage slika,int potrebnaSirina, int potrebnaDuzina, float kvaliteta)
   {
    int sirina,duzina;
    byte[] out;
    ...
    try {
       ...
       if (potrebnaDuzina>0)
       {
        ...
        duzina*=omjerD;
               ...
               java.awt.Graphics2D graf =(java.awt.Graphics2D) image.getGraphics();
                graf.setRenderingHint(java.awt.RenderingHints.KEY_ANTIALIASING,java.awt.RenderingHints.VALUE_ANTIALIAS_ON);
                graf.setRenderingHint(java.awt.RenderingHints.KEY_ALPHA_INTERPOLATION,java.awt.RenderingHints.VALUE_ALPHA_INTERPOLATION_QUALITY);
 ...
 return out;
  ...
  public byte[] preformatirajSlikuKaoJPEG(java.awt.image.BufferedImage slika, float kvaliteta)
     {
      int sirina,duzina;
      byte[] out;
   ...
   return out;
    ...
    public java.awt.image.BufferedImage preformatirajSliku(java.awt.image.BufferedImage slika,int potrebnaSirina)
      {
        int sirina,duzina;
     ...
     return image;
      ...
      public java.awt.image.BufferedImage preformatirajSlikuBezAliasa(java.awt.image.BufferedImage slika,int potrebnaSirina)
    {
      int sirina,duzina;
     java.awt.image.BufferedImage image;
     byte[] out;
      ...
      try {
            ...
            duzina*=omjer;
                 ...
                 java.awt.Graphics2D graf =(java.awt.Graphics2D) image.getGraphics();
                  ...
                  graf.setRenderingHint(java.awt.RenderingHints.KEY_FRACTIONALMETRICS,java.awt.RenderingHints.VALUE_FRACTIONALMETRICS_ON);
   ...
   return image;
      ...
      public java.awt.image.BufferedImage preformatirajSlikuPoDuzini(java.awt.image.BufferedImage slika,int potrebnaDuzina)
        {
          int sirina,duzina;
         java.awt.image.BufferedImage image;
         byte[] out;
         ...
         if (slika==null) return null;
          ...
          try {
                ...
                if (duzina<potrebnaDuzina) return slika;
                ...
                duzina*=omjer;
                      ...
                      // Get a graphics region, using the Frame
                     image = new java.awt.image.BufferedImage(sirina, duzina, java.awt.image.BufferedImage.TYPE_INT_RGB);
...
public java.awt.image.BufferedImage preformatirajSliku(java.io.InputStream ins,int potrebnaSirina)
{
   int sirina,duzina;
   ...
   byte[] out,in;
         ...
         try {
          ...
          int velicina=ins.available();
           ...
           duzina=slika.getHeight();
               ...
               {
                 System.out.println("Null pointer greska kod smanjivanja slike: "+e+" Linija: "+e.getStackTrace()[0].getLineNumber());
                 return null;
               }
               catch (java.io.IOException ioe)
               {
      ...
      return image;
       ...
       public static java.awt.image.BufferedImage vratiKaoBufferedImage(java.io.InputStream ins)
        {
         ...
         if (ins==null) return null;
            ...
            try {
             ...
             Logger.log("Greska u PictureResizer / metoda vratiKaoBufferedImage: "+ex);
              return null;
            }
            finally
            {
...
private byte[] zakodirajUJpeg(java.awt.image.BufferedImage slika, float kvaliteta)
{
