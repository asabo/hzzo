...
public class JSpinnerDateEditor extends JSpinner implements IDateEditor,
	...
	/**
	 * @see biz.sunce.toedter.calendar.IDateEditor#getMinSelectableDate()
	 */
	...
	/**
	 * @see biz.sunce.toedter.calendar.IDateEditor#setMaxSelectableDate(java.util.Date)
	 */
	...
	/**
	 * @see biz.sunce.toedter.calendar.IDateEditor#setMinSelectableDate(java.util.Date)
	 */
	...
	/**
	 * @see biz.sunce.toedter.calendar.IDateEditor#setSelectableDateRange(java.util.Date, java.util.Date)
	 */
